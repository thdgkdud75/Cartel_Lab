  ...
  return (
    <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
      ...
      {gcal.connected ? (
        ...
        <a href={`${PLANNER_BASE}${gcal.connect_url}`} style={{ border: 0, borderRadius: 8, padding: '6px 10px', fontSize: 12, fontWeight: 700, textDecoration: 'none', background: '#ff6f0f', color: '#fff' }}>
          구글 연결
        </a>
      )}
    </div>
